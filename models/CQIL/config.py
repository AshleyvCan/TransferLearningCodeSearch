...
def get_config():
    ...
    config['train'] = 'codesearchnet/codesearchnet_1train.json' 
    config['valid'] = 'codesearchnet/codesearchnet_1test.json' 
 
    config['valid_lex'] = 'valid/'
    config['eval'] = 'staqc/test_data_staq.json' 
    config['recom'] = 'codenetsearch/codesearchnet_1test.json' 
    config['eval_lex'] = 'eval/'
    config['recom_lex'] = 'recom_csn/'
    config['type'] = 0
