...
if __name__ == '__main__':
  ...
  os.environ['CODENN_DIR'] = 'C:/Users/Gebruiker/Documents/Graduation_Internship/codenn-master/'
  os.environ["CODENN_WORK"] = 'C:/Users/Gebruiker/Documents/Graduation_Internship/codenn-master/'
  lang = sys.argv[1]
  max_code_len = int(sys.argv[2])
  max_nl_len = int(sys.argv[3])
  code_unk_threshold = int(sys.argv[4])
  nl_unk_threshold = int(sys.argv[5])
  print(os.environ['CODENN_DIR'])
  print(code_unk_threshold, nl_unk_threshold)
  ...
  for i in range(22):
    get_data(os.environ['CODENN_DIR'] + 'data/stackoverflow/' + '/test_batch'+ str(i) +'.txt', vocab, True, max_code_len, max_nl_len)
